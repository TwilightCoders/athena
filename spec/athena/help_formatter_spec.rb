...
RSpec.describe Athena::HelpFormatter do
  let(:cmd_class) do
  ...
  let(:formatter) { Athena::HelpFormatter.new(cmd_class) }
  ...
  describe "with subcommands" do
    ...
    let(:output) { Athena::HelpFormatter.new(parent).format }
  ...
  describe "with version (Tool)" do
    ...
    let(:output) { Athena::HelpFormatter.new(tool).format }
  ...
  describe "command_path" do
    let(:output) { Athena::HelpFormatter.new(cmd_class, command_path: ["app", "deploy"]).format }
